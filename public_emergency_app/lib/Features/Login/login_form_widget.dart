          ...
          children: [
            ...
            TextFormField(
              ...
              validator: (value) {
                ...
                if (value.trim().toLowerCase() == 'admin') return null;
                bool isValid = RegExp(
            ...
            // Hide Forgot Password for admin
            Visibility(
              visible: controller.emailController.text.trim().toLowerCase() != 'admin',
              child: Align(
              ...
              return SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: controller.isAdminLogging.value
                      ...
                      : controller.isLoading.value  // ← ADDED THIS
