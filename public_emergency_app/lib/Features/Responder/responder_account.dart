...
class _ResponderAccountPageState extends State<ResponderAccountPage> {
  ...
  void _showPasswordUpdateDialog() {
    ...
    // Local variables for visibility inside the dialog
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              ...
              // Navigate to login screen - change this to your actual login route
      ...
      body: _isLoading
          ...
          : SingleChildScrollView(
              child: Column(
                children: [
                  // ============================================================
                  // PROFILE HEADER CARD - Start (CENTERED USERNAME & RESPONDER TYPE)
                  // ============================================================
                  // ============================================================
  ...
  child: Container(
    ...
    child: Stack(
      children: [
        ...
        // Username and Responder Type - Centered on whole screen
        Center(
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
